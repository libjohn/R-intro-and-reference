...
# The Wow Factor
First, let's check out some cook visualizations accomplished in [R] with with minimal code.  The examples below come from [5 data visualizations in 5 minutes: each in 5 lines or less of R](http://www.computerworld.com/article/2893271/business-intelligence/5-data-visualizations-in-5-minutes-each-in-5-lines-or-less-of-r.html) by Sharon Machlis[^5]

There are 5 separate "Wow" factor visuzlisations in the [output directory](../output).  Check them out.  Or if you just want to see the code, look in the [scripts](../scripts) directory.  (for best viewing results clone the [github repository](https://github.com/libjohn/R-intro-and-reference))
